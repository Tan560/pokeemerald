...
extern const u8 EventScript_ModeSelection[];

void FieldCB_NewGameModeSelection(void)
{
    ScriptContext_SetupScript(EventScript_ModeSelection);
...
void CB2_NewGame(void)
{
    ...
    gFieldCallback = FieldCB_NewGameModeSelection;
    gFieldCallback2 = NULL;
